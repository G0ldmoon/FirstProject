...
public class ManagerController {
	...
	//고객 문의 게시판
	 ...
	 //고객 문의 상세페이지
	 @GetMapping("/csdetail")
	 	public void getCsDetail(@RequestParam("csbno") Long csbno, Model model) {

	 		log.info("문의 상세페이지" + csbno);
	 	
	 		model.addAttribute("kkk", service.getCsDetail(csbno));
	 		
	 		model.addAttribute("reply", service.replyList(csbno));
	 	}
	 ...
	 * String posttWirte(CsreplyVO vo) throws Exception {
	 * 
	 * service.write(vo);
	 * 
